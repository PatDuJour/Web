...
add_theme_support ( 'genesis-menus' , array ( 'primary' => __( 'Header Menu', 'atmosphere' ), 
	                                          'secondary' => __( 'Footer Menu', 'atmosphere' ),
	                                          'tertiary' => __( 'Sub-Footer Menu', 'atmosphere' ) ) );    //*Customized
...
add_image_size( 'front-page-featured', 1200, 1200, TRUE );   /*customized*/
...
//* Add additional widget area
genesis_register_sidebar( array(
	'id'         => 'front-page-video',
	'name'       => __( 'Front Page Video Demo', 'atmosphere' ),
	'description' => __( 'This is the video demo section on the front page.', 'atmosphere' ),
) );

//* Hook additional widget area (*this is for video demo)
//* see in front-page.php
...
genesis_register_sidebar( array( 
	'id'          => 'social-footer',
	'name'        => __( 'Social Footer', 'atmosphere' ),
	'description' => __( 'This is the social footer widget area', 'atmosphere' ),
) );

//* Hook social widget area before site footer
add_action( 'genesis_footer', 'atmosphere_social_footer_widget_area', 7 );
function atmosphere_social_footer_widget_area() {
...
function sp_footer_creds_filter( $creds ) {
	$creds = '[footer_copyright] &middot; <a href="/">Hillotask</a> &middot; All rights reserved.';
	// $creds = '';
	return $creds;
}

//* Hook tertiary menu after footer widget area
add_action( 'genesis_after_footer', 'legal_footer_menu', 8);
function legal_footer_menu() {

	genesis_nav_menu( array(
		'theme_location'  => 'tertiary',
		'container'       => 'div',
		'container_class' => 'wrap',
		'menu_class'      => 'menu nav-secondary genesis-nav-menu menu-footer',
		'depth'           => 1
	) );
}
